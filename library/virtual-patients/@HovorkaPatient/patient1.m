...
this.param.w = 75; % Patient weight (kg).
...
this.param.St = 18.5e-4; % Insulin sensitivity of glucose disposal (L / (min mU)).
this.param.Sd = 5.1e-4; % Insulin sensitivity of glucose disposal (L / (min mU)).
...
this.param.ke = 0.12; % Insulin elimination rate (1/min).
...
this.param.Vg = 150; % Glucose distribution volume (mL/kg).
